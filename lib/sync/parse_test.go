...
func TestProductGender(t *testing.T) {
	...
	cache := map[string]*data.Category{
		"drake":       &data.Category{Gender: data.ProductGenderMale, Value: "drake"},
		"beyonce":     &data.Category{Gender: data.ProductGenderFemale, Value: "beyonce"},
		"brucejenner": &data.Category{Gender: data.ProductGenderUnisex, Value: "brucejenner"},
		"shoe":        &data.Category{Gender: data.ProductGenderUnisex, Value: "shoe"},
		"lace-up":     &data.Category{Weight: 1, Gender: data.ProductGenderUnisex, Value: "lace-up"},

		"shirt":   &data.Category{Weight: 1, Gender: data.ProductGenderMale, Value: "shirt"},
		"t-shirt": &data.Category{Weight: 1, Gender: data.ProductGenderUnisex, Value: "t-shirt"},
	}
	...
	tests := []tagTest{
		{
			...
			expected: &data.Category{Value: "drake", Gender: data.ProductGenderMale},
		},
		{
			name:     "male category with gender keyword female",
			place:    placeUnisex,
			inputs:   []string{"females love drake"},
			expected: &data.Category{Value: "drake", Gender: data.ProductGenderFemale},
		},
		{
		...
		},
		{
			...
			expected: &data.Category{Value: "beyonce", Gender: data.ProductGenderFemale},
		},
		{
			name:     "female category with gender keyword male",
			place:    placeUnisex,
			inputs:   []string{"all men should listen to at least one beyonce song"},
			expected: &data.Category{Value: "beyonce", Gender: data.ProductGenderMale},
		},
		{
		...
		},
		{
			...
			expected: &data.Category{Value: "brucejenner", Gender: data.ProductGenderMale},
		},
		{
			name:     "unisex category with gender keyword female",
			place:    placeUnisex,
			inputs:   []string{"brucejenner became a woman"},
			expected: &data.Category{Value: "brucejenner", Gender: data.ProductGenderFemale},
		},
		{
			name:     "unisex category with no gender keyword",
			place:    placeUnisex,
			inputs:   []string{"brucejenner was on vanity fair cover"},
			expected: &data.Category{Value: "brucejenner", Gender: data.ProductGenderUnisex},
		},
		// place gender
		{
		...
		},
		{
			...
			expected: &data.Category{Value: "t-shirt", Gender: data.ProductGenderMale},
		},
		{
			...
			expected: &data.Category{Value: "lace-up", Gender: data.ProductGenderFemale},
		},
	}
